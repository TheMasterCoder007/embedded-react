...
// Arrays and fragments around them are unwrapped, so a mapped list of shapes works; a component is not,
// since flattening the subtree means never rendering it — inline its shapes or return them as an array.
