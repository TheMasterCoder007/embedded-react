...
The starter is deliberately small: a card with a pulsing logo, a counter-button, and the panel size
laid out to fit any panel. To begin from a complete app instead, pass a template:
