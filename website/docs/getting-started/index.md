...
1. **[Installation](/getting-started/installation).** Scaffold a project with one command. All you
   need is Node.js.
2. **[Run it in the simulator](/getting-started/simulator).** Edit `App.jsx`, save, and watch it
   hot-reload at your panel's exact resolution.
3. **[Your first board](/getting-started/first-board).** Build the app for a real device and flash
