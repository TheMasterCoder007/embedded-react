...
int main(int argc, char** argv)
{
    ...
    /* Hand the demo's baked assets (images + fonts) to the engine now that the backend init above set
     * up the registries. Generated by `npm run build`; absent before the first build (built-in demo). */
#if defined(ER_HAVE_BAKED_ASSETS)
    er_register_assets();
#endif
